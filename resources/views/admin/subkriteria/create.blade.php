                ...
                <form action="{{ url('subkriteria') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_subkriteria" placeholder=""
                                name="nama_subkriteria" value="{{ Session::get('nama_subkriteria') }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="nilai_subkriteria">Nilai</label>
                            <input type="number" class="form-control" id="nilai_alternatif" placeholder=""
                                name="nilai_subkriteria" value="{{ Session::get('nilai_subkriteria') }}">
                        </div>
                        <div class="form-group col-md-6">
